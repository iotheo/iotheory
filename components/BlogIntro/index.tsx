...
const getEstimatedReadTime = (wordCount: number) => Math.round((wordCount / WORDS_PER_MINUTE));

const getCoffeeConsumption = (durationInMinutes: number): string => '☕'.repeat(Math.round((durationInMinutes / 5))) || '☕';
